...
`elsif I9
    ...
    `define PAT_LEN 40
`elsif mixed
    `define IDATA  "../00_TESTBED/pattern/INSTm_I.dat"
    `define ODATA  "../00_TESTBED/pattern/INSTm_O.dat"
    `define PAT_LEN 40
`elsif matlab
    `define IDATA  "../00_TESTBED/pattern/i_data.dat"
    `define ODATA  "../00_TESTBED/pattern/o_data.dat"
    `define PAT_LEN 45000
`else
    `define IDATA  "../00_TESTBED/pattern/INST0_I.dat"
    `define ODATA  "../00_TESTBED/pattern/INST0_O.dat"
    `define PAT_LEN 40
...
module testbench #(
	...
	$readmemb("../00_TESTBED/pattern/valid_user.dat", valid_seq);
